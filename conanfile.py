...
lib_list = ['atomic', 'chrono', 'date_time', 'filesystem', 'regex', 'thread', 'system', 'test']
...
class BoostConan(ConanFile):
    ...
    url = "https://github.com/Yadoms/conan-boost"
    ...
    def zip_bzip2_requires_needed(self):
        return not self.options.header_only
    ...
    def package(self):
        ...
        self.copy(pattern="*", dst="stage/lib", src="%s/stage/lib" % self.folder_name)
